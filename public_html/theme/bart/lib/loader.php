...
class BLoader{
    ...
    public static function registAll($dirpath){
        try{
            ...
            foreach ($iterator as $file){
                ...
                $dirname = str_trim(str_replace( '\\', '/', dirname($file->getPathName())), BT_LIB_PATH.'/class/');
    ...
    **/
    public static function autoload($classname){
        ...
        if(!array_key_exists($classname, self::$classes)){
            include_once(BT_LIB_PATH.'/class/system/error.php');
    ...
    **/
    public static function autoloadSetup(){
        spl_autoload_register('\kr\bartnet\BLoader::autoload');
    }
