...
<div class="bo-basic-list">
    ...
    <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div class="list-wrap">
            <div class="list-head">
                ...
                <?php }?>
                    ...
                    <div class="cell cell-thumb d-none d-md-table-cell px-2">썸네일</div>
        ...
        for ($i=0; $i<count($list); $i++) {
            ...
            if($thumb){
                $img = '<img src="'.$thumb['src'].'" class="img-fluid border" alt="'.$list[$i]["subject"].'">';
            }else{
        ...
        ?>
            ...
            <?php }?>
                    ...
                    <div class="cell cell-thumb d-none d-md-table-cell p-2"><a href="<?php echo $list[$i]['href'] ?>"><?php echo $img?></a></div>
