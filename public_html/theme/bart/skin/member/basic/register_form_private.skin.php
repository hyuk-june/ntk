...
<div class="mbskin">
    ...
    <form id="fregisterform" name="fregisterform" class="form-horizontal" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 form-text text-muted">영문자, 숫자, _ 만 입력 가능. 최소 3자이상</div>
            </div>
        ...
        <?php if ($req_nick) {  ?>
            <div class="form-group row">
                <label for="reg_mb_nick" class="col-sm-2 col-form-label">닉네임</label>
                <div class="col-sm-4">
                ...
                <div class="col-sm-6 form-text text-muted">공백없이 한글,영문,숫자만 가능 (한글2자, 영문4자 이상)</div>
            </div>
        <?php }?>
        ...
        <?php if ($config['cf_use_homepage']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_homepage" class="col-sm-2 col-form-label">홈페이지</label>
                <div class="col-sm-4">
                    <input type="text" name="mb_homepage" value="<?php echo get_text($member['mb_homepage']) ?>" id="reg_mb_homepage" <?php echo $config['cf_req_homepage']?"required":""; ?> class="form-control form-control-sm <?php echo $config['cf_req_homepage']?"required":""; ?>" size="70" maxlength="255">
                </div>
            </div>
        <?php }  ?>
        ...
        <?php if ($config['cf_use_tel']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_tel" class="col-sm-2 col-form-label">전화번호</label>
                <div class="col-sm-4">
                    <input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" <?php echo $config['cf_req_tel']?"required":""; ?> class="form-control form-control-sm <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20">
                </div>
            </div>
        <?php }  ?>
        ...
        <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_hp" class="col-sm-2 control-label">휴대폰번호</label>
                <div class="col-sm-4">
                    <input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="form-control form-control-sm <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20">
        ...
        <?php if ($config['cf_use_signature']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_signature" class="col-sm-2 col-form-label">서명</label>
                <div class="col-sm-10">
                    <textarea name="mb_signature" id="reg_mb_signature" <?php echo $config['cf_req_signature']?"required":""; ?> class="form-control form-control-sm <?php echo $config['cf_req_signature']?"required":""; ?>"><?php echo $member['mb_signature'] ?></textarea>
                </div>
            </div>
        <?php }  ?>
        ...
        <?php if ($config['cf_use_profile']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_profile" class="col-sm-2 col-form-label">자기소개</label>
                <div class="col-sm-10">
                    <textarea name="mb_profile" id="reg_mb_profile" <?php echo $config['cf_req_profile']?"required":""; ?> class="form-control form-control-sm <?php echo $config['cf_req_profile']?"required":""; ?>"><?php echo $member['mb_profile'] ?></textarea>
                </div>
            </div>
        <?php }  ?>
        ...
        <?php if ($config['cf_use_member_icon'] && $member['mb_level'] >= $config['cf_icon_level']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_icon" class="col-sm-2 col-form-label">회원아이콘</label>
                <div class="col-sm-3">
            ...
            <div class="form-group row">
            	<div class="offset-sm-2 col-sm-10">
                    <img src="<?php echo $mb_icon_url ?>" alt="회원아이콘" class="thumbnail">
                    <label>
            ...
            <div class="form-group row">
                <div class="offset-sm-2 col-sm-10">
                    <span class="form-text text-muted">이미지 크기는 가로 <?php echo $config['cf_member_icon_width'] ?>픽셀, 세로 <?php echo $config['cf_member_icon_height'] ?>픽셀 이하로 해주세요.<br>
                        gif만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
                </div>
            </div>
        ...
        <?php }  ?>
            ...
            <div class="form-group row">
                <label for="reg_mb_profile" class="col-sm-2 col-form-label">정보메일수신</label>
        ...
        <?php if (isset($member['mb_open_date']) && $member['mb_open_date'] <= date("Y-m-d", G5_SERVER_TIME - ($config['cf_open_modify'] * 86400)) || empty($member['mb_open_date'])) { // 정보공개 수정일이 지났다면 수정가능  ?>
            ...
            <div class="form-group row">
                <div class="offset-sm-2 col-sm-10">
                    <span class="form-text text-muted">정보공개를 바꾸시면 앞으로 <?php echo (int)$config['cf_open_modify'] ?>일 이내에는 변경이 안됩니다.</span>
                </div>
            </div>
        ...
        <?php if ($w == "" && $config['cf_use_recommend']) {  ?>
            <div class="form-group row">
                <label for="reg_mb_recommend" class="col-sm-2 col-form-label">추천인아이디</label>
                <div class="col-sm-4">
                    <input type="text" name="mb_recommend" id="reg_mb_recommend" class="form-control form-control-sm">
                </div>
            </div>
        <?php }  ?>
    ...
    <div class="btn_confirm text-center">
        ...
        <a href="<?php echo G5_URL ?>" class="btn btn-info">취소</a>
    </div>
