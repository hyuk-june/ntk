Bt.builder = {
  ...
  openWidgetAppender: function () {
    ...
    Bt.win.open(
      bt_url +
        "/adm/widget_append.php?wg_skindir=" +
        wg_skindir +
        "&wp_id=" +
        wp_id +
        "&wg_id=" +
  ...
  openWidgetEditor: function (e) {
    ...
    Bt.win.open(
      bt_url + "/adm/widget_setup.php?wg_idx=" + wg_idx,
      "we_win",
      700,
      800
    );
  ...
  openMyPhoto: function (event) {
    Bt.win.open(
      g5_url + "/index.php?mtype=module&mid=_userphoto",
      "myphoto_win",
      380,
      380,
      false
  ...
  openFrameSetup: function () {
    ...
    Bt.win.open(
      bt_url + "/adm/frame_setup.php?url=" + url + "&frame_skin=" + frame_skin,
      "frame_win",
      600,
      800,
      false
...
$(function () {
  ...
  $(document).on(
    "click",
    ".bt-widget-container > .control-header > .fa-plus",
    Bt.builder.openWidgetAppender
  );
  $(document).on(
    "click",
    ".bt-widget .control-header .fa-cog",
    Bt.builder.openWidgetEditor
  );
